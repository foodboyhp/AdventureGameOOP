...
public class SaveGame {
	...
	public void saveGame() {
		try {
			...
			bw.write(String.valueOf(gp.currentPlayer));
			bw.newLine();
			...
			bw.newLine();
			bw.write(String.valueOf(gp.player.numOfMonKilled[0]));
			bw.newLine();
			bw.write(String.valueOf(gp.player.numOfMonKilled[1]));
			bw.newLine();
			bw.write(String.valueOf(gp.player.numOfMonKilled[2]));
			bw.newLine();
			bw.write(String.valueOf(gp.player.currentMapAvailable));
			bw.newLine();
			bw.close();
		}
		catch (Exception e) {
	...
	public void loadSavedGame() {
		try {
			...
			gp.currentPlayer = Integer.parseInt(s);
			s = br.readLine();
			...
			s = br.readLine();
			gp.player.numOfMonKilled[0] = Integer.parseInt(s);
			s = br.readLine();
			gp.player.numOfMonKilled[1] = Integer.parseInt(s);
			s = br.readLine();
			gp.player.numOfMonKilled[2] = Integer.parseInt(s);
			s = br.readLine();
			gp.player.currentMapAvailable = Integer.parseInt(s);
			br.close();
		}catch (Exception e) {
			e.printStackTrace();// TODO: handle exception
		}
